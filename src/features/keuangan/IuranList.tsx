                    ...
                    <div className="bg-white rounded-[24px] p-6 shadow-premium border border-slate-100">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                ...
                                <Text.H2 className="!text-brand-600 !font-bold">INV-{dateUtils.format(shareData.history.tanggal_bayar, 'YYYYMMdd')}-{shareData.history.id.substring(0,2).toUpperCase()}</Text.H2>
                            </div>
